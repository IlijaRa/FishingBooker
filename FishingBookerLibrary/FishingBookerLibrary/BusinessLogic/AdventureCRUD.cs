...
namespace FishingBookerLibrary.BusinessLogic
{
    public class AdventureCRUD
    {
        ...
        public static List<string> LoadAdventureTitlesByInstructor(string instructorId)
        {
            ...
            return SSMSDataAccess.LoadAdventureByInstructorId<string>(sql, instructorId);
        }

        public static List<Adventure> LoadAdventuresByInstructorId(string instructorId)
        {
            string sql = @"SELECT *
                            FROM dbo.Adventures
                            WHERE InstructorId = @InstructorId;";
            return SSMSDataAccess.LoadAdventureByInstructorId<Adventure>(sql, instructorId);
        }
        ...
        public static Adventure LoadAdventuresByName(string adventureTitle)
        {
            string sql = @"SELECT *
                            FROM dbo.Adventures
                            WHERE Title = @Title;";
            return SSMSDataAccess.LoadAdventuresByName<Adventure>(sql, adventureTitle);
        }

        public static Adventure LoadAdventureById(int adventureId)
        {
            string sql = @"SELECT *
                            FROM dbo.Adventures
                            WHERE Id = @Id;";
            return SSMSDataAccess.LoadAdventureById<Adventure>(sql, adventureId);
        }
