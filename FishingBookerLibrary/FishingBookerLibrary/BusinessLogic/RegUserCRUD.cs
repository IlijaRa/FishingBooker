...
namespace FishingBookerLibrary.BusinessLogic
{
    public static class RegUserCRUD
    {
        public static int CreateEmployee(string name, 
            ...
            string sql = @"INSERT INTO dbo.RegUser (Name, Surname, PhoneNumber, EmailAddress, Address, City, Country)
                           VALUES (@Name, @Surname, @PhoneNumber, @EmailAddress, @Address, @City, @Country);";
        ...
        {
            string sql = "SELECT * FROM dbo.RegUser;";
